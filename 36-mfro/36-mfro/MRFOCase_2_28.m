...
function [bestSolution, bestFitness, iter]=MRFOCase_2_28(fhd, dimension, maxIteration, fNumber)
    settings;
    Low = lbArray;
    Up = ubArray;
    Dim = dimension;
        ...
        for i=2:nPop
            ...
            for i=1:nPop 
                fdbIndex = rouletteFitnessDistanceBalance(PopPos, PopFit);
                    newPopPos(i,:)=PopPos(fdbIndex,:)+S*(rand*BestX-rand*PopPos(i,:)); %Equation (8)
            end
