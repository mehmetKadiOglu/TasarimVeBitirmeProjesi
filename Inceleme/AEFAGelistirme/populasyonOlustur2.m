function populasyon = populasyonOlustur2(lbArray, ubArray, dimension, populasyonSize, secenek)
...
function populasyon = DegiskenSinirAraligindaPopulasyonOlustur(lbArray, ubArray, dimension, populasyonSize, secenek)
    ...
    for i=1:dimension
        ...
        if lbArray(i)<=0 && ubArray(i)>=0
            ...
            populasyonSutun = sutunOlustur(0.2, 0.8, populasyonSize, ubArray(i), 1e-10, lbArray(i), 1e-10);
