...
function [bestSolution, bestFitness, iter]=Case_2_18(fhd, dimension, maxIteration, fNumber)
        ...
        if r<1/3
            ...
            if 1/3<r<2/3            
                ...
                if rand<0.4
                    ...
                    newPopPos(i,:)=PopPos(i,:)+C.*(r2.*(PopPos(fdbIndex,:)- newPopPos(1,:))+(1-r2).*(PopPos(i,:)-PopPos(randi([2 i-1]),:))); %equation (8)
                else
