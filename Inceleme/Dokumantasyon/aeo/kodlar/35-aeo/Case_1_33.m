...
function [bestSolution, bestFitness, iter]=Case_1_33(fhd, dimension, maxIteration, fNumber)
    ...
    for It=1:MaxIt    
        ...
        for i=3:nPop
         ...
         for i=1:nPop
            ...
            newPopPos(i,:)=PopPos(indOne,:)+3*randn(1,Matr(Ind)).*((r3*randi([1 2])-1)*PopPos(indOne,:)-(2*r3-1)*PopPos(fdbIndex,:)); %equation (9)
          end
