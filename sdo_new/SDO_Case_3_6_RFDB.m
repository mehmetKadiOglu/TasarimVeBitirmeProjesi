...
function [bestSolution, bestFitness, iter]=SDO_Case_3_6_RFDB(fhd, dimension, maxIteration, fNumber)
    ...
    for Iter=1:MaxIt   
        ...
        for i=1:MarketSize 
            ...
            Beta=2*cos((2*pi)*rand(1,Matr(Ind))); % Equation (17)
             ...
             if rand<0.9
                NewCommQuantity=CommQuantityEqu+Alpha.*( CommPrice(i,:)-CommPrice(fdbIndex,:)); %Equation (13)  
             else
                if rand>0.5               
