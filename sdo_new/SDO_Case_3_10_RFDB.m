...
function [bestSolution, bestFitness, iter]=SDO_Case_3_10_RFDB(fhd, dimension, maxIteration, fNumber)
    ...
    for Iter=1:MaxIt   
        ...
        for i=1:MarketSize 
            ...
            NewCommQuantity=CommQuantityEqu+Alpha.*( CommPrice(i,:)-CommPriceEqu); %Equation (13)   
             ...
             if rand<0.9
                NewCommPrice=CommPriceEqu-Beta.*(CommPrice(fdbIndex,:)-CommQuantityEqu );% Equation (14)
             else
