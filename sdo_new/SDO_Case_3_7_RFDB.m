...
function [bestSolution, bestFitness, iter]=SDO_Case_3_7_RFDB(fhd, dimension, maxIteration, fNumber)
    ...
    for Iter=1:MaxIt   
        ...
        for i=1:MarketSize 
            ...
            NewCommQuantity=CommQuantityEqu+Alpha.*( CommPrice(i,:)-CommPriceEqu); %Equation (13)   
             ...
             if rand<0.4
                NewCommPrice=CommPrice(fdbIndex,:)-Beta.*(NewCommQuantity-CommQuantityEqu );% Equation (14)
             else
