...
function [bestSolution, bestFitness, iter]=SDO_Case_3_1_RFDB(fhd, dimension, maxIteration, fNumber)
    ...
    for Iter=1:MaxIt   
        ...
        for i=1:MarketSize 
            ...
            Beta=2*cos((2*pi)*rand(1,Matr(Ind))); % Equation (17)
             ...
             if rand<0.4
                NewCommQuantity=CommPrice(fdbIndex,:)+Alpha.*( CommPrice(i,:)-CommPriceEqu); %Equation (13)  
             else
