...
function [bestSolution, bestFitness, iter]=SDO_Case_4_3_RFDB(fhd, dimension, maxIteration, fNumber)
    ...
    for Iter=1:MaxIt   
        ...
        for i=1:MarketSize 
            ...
            Beta=2*cos((2*pi)*rand(1,Matr(Ind))); % Equation (17)
             ...
             if rand<0.4
                NewCommQuantity=CommQuantityEqu+Alpha.*( CommQuantity(fdbIndex,:)-CommPriceEqu); %Equation (13)  
             else
