...
function [bestSolution, bestFitness, iter]=Hgso_Case_3_5()

[~, var_down, var_up, dim, maxIteration, var_n_gases] = terminate();
...
for var_iter = 1:var_niter
    ...
    for i=1:var_n_types    %5
        ...
        for j=1:var_n_gases/var_n_types; % 50/5 10 adet
            ...
            fdbIndex = rouletteFitnessDistanceBalance(X, fitness);
            for k=1:dim
                if rand<0.5
