function [ y ] = problems( x, number )
    ...
    elseif(number == 14)%cantileverBeam
        ...
        y = y + 10000*ceil(cantileverBeam(x));
    ...
    elseif(number == 15)%multipleDiskClutchBrake
        ...
        y = y + 1000*ceil(multipleDiskClutchBrake(x));    
    ...
    elseif(number == 19) %benchmarkFunction1
        ...
        y = 5*y1 - 5*y2 - y3;
        y = y + 10000*ceil(benchmarkFunction1(x));
    % Error
    else
        y = inf;
    end
